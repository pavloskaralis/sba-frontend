...
class ContentComponent {
    ...
    addIgnored(ignored) {
        ...
        this.response.forEach(response => {
            if (response.word === ignored && response.misspelled)
                response.misspelled = false;
        });
    }
    //copy button
    copyContent() {
...
PopupComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PopupComponent, selectors: [["popup"]], inputs: { status: "status" }, outputs: { closeRequest: "closeRequest" }, decls: 6, vars: 7, consts: [[1, "popup-container"], [1, "message-wrap"], [1, "button-wrap"], [1, "button", 3, "click"]], template: function PopupComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
